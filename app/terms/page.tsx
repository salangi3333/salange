    ...
    <main className="mx-auto min-h-screen max-w-content px-6 py-16">
      ...
      <Article no="제9조" title="디지털 콘텐츠 제공">
        <p>
          ...
          생성·제공되는 디지털 콘텐츠입니다. 결제가 승인되어 리포트가 이용자
          화면에 실제로 노출된 시점을 콘텐츠의 "제공 개시" 시점으로 봅니다.
        </p>
      </Article>
      ...
      <Article no="제10조" title="청약철회·취소·환불">
        <p>
          ...
          제1조부터 제4조까지를 따릅니다. 결제 후 어떠한 경우에도 환불이
          불가능하다는 취지의 조항은 두지 않으며, 「전자상거래 등에서의
          소비자보호에 관한 법률」 등 관계 법령에 따른 소비자의 권리를
          보장합니다.
        </p>
      </Article>
